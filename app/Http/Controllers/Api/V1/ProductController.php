...
class ProductController extends Controller
{
    ...
    public function productMetas(Product $product){
        ...
        return $this->apiResponse(new MetaProductCollection($product->metas));
    }

    public function productColors(Product $product){
        if (!$this->policyService->authorize(['admin'], ['read-product', 'read-color-product']))
            return $this->forbiddenResponse();
